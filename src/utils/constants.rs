...
pub static SEARCH_PATH: Lazy<PathBuf> = Lazy::new(|| ODYSSEY_PATH.join("search_bis"));
pub static DATABASES_PATH: Lazy<PathBuf> = Lazy::new(|| ODYSSEY_PATH.join("databases_bis"));
